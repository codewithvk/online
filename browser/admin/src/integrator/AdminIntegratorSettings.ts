...
class SettingIframe {
	...
	private generateServerPrivateSettingUI(data: ServerPrivateSettings): void {
		...
		let serverPrivateContainer = document.getElementById('serverprivate-section');
		...
		serverPrivateContainer.appendChild(this.createServerPrivateSettingActions());
	...
	private createServerPrivateSettingActions(): HTMLDivElement {
		return this.createSettingsActions(
			...
			() => {
				// Return settings directly (already in correct format)
